...
import com.firti.webservice.entities.pojo.DateCountPair;
...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query("SELECT new com.firti.webservice.entities.pojo.DateCountPair(u.created, count(u.id)) FROM User u WHERE u.created BETWEEN :fromDate AND :toDate")
